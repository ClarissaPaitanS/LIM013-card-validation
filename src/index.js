...
// Abrir la ventana modal - Formulario Pago
  ...
  btnAdquirir.addEventListener('click',function () {
    modalPago.classList.add("mostrar");
  })
...
const limpiarDatos=document.getElementById("CreditCard");
limpiarDatos.addEventListener('click',limpiarCampos);
...
if (validarDatos()!==false) {
  ...
  mensajeA.classList.remove("visible");
  mensajeC.classList.add("visible");
 ...
 // mensajeC.style.display="inline";
  alert("Número de tarjeta es Válido");
    ...
    mensajeA.classList.add("visible");
